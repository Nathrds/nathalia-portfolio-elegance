...
import { Mail, Linkedin, Monitor, Award, Github, User, Calendar, Settings, Code, Star } from 'lucide-react';
...
const Index = () => {
  ...
  const skills = [
    "HTML", "TypeScript", "Figma", "Others",
    "CSS", "JavaScript", "React Native", "English",
    "JavaScript", "React", "Kotlin", "Spanish"
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-sm border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold">N
            <img src={Logo} alt="Portfolio Logo NR" className="pt-24 pb-16 px-6"/>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-gray-400 mt-2">Full-stack developer specialized in modern web technologies and user experience</p>
              </div>
            </div>
      ...
      <section className="py-16 px-6 bg-gray-900/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Creative problem solver passionate about building elegant solutions that combine functionality with outstanding user experience.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-8">Passionate developer with expertise in modern technologies</p>
              
              <div className="space-y-6">
                <div className="bg-gray-900 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold mb-3 text-purple-400">Personal Description</h4>
                  <p className="text-gray-300">
                    I'm a dedicated full-stack developer with a passion for crafting beautiful and functional web applications. My journey in tech has been driven by curiosity and a love for solving complex problems.
                  </p>
                </div>
                
                <div className="bg-gray-900 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold mb-3 text-purple-400">Professional Objective</h4>
                  <p className="text-gray-300">
                    To leverage my technical skills and creative mindset to build innovative solutions that make a positive impact on users' lives while continuously growing as a developer and team player.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {academics.map((academic, index) => (
              <div key={index} className="bg-gray-900 p-6 rounded-lg text-center hover:bg-gray-800 transition-colors">
                ...
                <h4 className="text-lg font-semibold mb-2">{academic.degree}</h4>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {skills.map((skill, index) => (
              <div key={index} className="bg-gray-900 px-4 py-3 rounded-lg text-center hover:bg-gray-800 transition-colors">
      ...
      <footer className="py-8 px-6 border-t border-gray-800">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-gray-400">© 2024 Nathalia Rodrigues Portfolio. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
